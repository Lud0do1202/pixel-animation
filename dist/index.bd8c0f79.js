...
})({"iY06d":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3a54f6acbd8c0f79";
"use strict";
...
parcelHelpers.export(exports, "PixelAnimation", ()=>(0, _pixelAnimation.PixelAnimation));
var _pixelAnimation = require("./pixel-animation/pixel-animation");

},{"./pixel-animation/pixel-animation":"7U9Xd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7U9Xd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PixelAnimation", ()=>PixelAnimation);
var PixelAnimation = /** @class */ function() {
    function PixelAnimation(container, cellSettings) {
     ...
     */ PixelAnimation.prototype.addFrame = function(frame) {
        var _this = this;
        // Get max rows
        if (frame.length > this.rows) this.rows = frame.length;
        // Get max cols
        frame.forEach(function(row) {
            if (row.length > _this.cols) _this.cols = row.length;
        });
        // Add the frame
    ...
    PixelAnimation.prototype.start = function(timeout) {
        ...
        this.interval = setInterval(function() {
            // Get the frame
            var frame = _this.frames[_this.iFrame];
            // Run the grid
            for(var i = 0; i < _this.rows; i++)for(var j = 0; j < _this.cols; j++){
                // Get the cell
                var cell = _this.container.querySelector('[row="'.concat(i, '"][col="').concat(j, '"]'));
                // Set transparent or color
                if (!frame[i][j] || frame[i][j] === ".") cell.style.backgroundColor = "transparent";
                else cell.style.backgroundColor = _this.cellSettings.color;
            }
            // Next frame
            _this.iFrame = (_this.iFrame + 1) % _this.frames.length;
        }, timeout);
    };
    PixelAnimation.prototype.stop = function() {
...
},{}]},["iY06d","lGvzx"], "lGvzx", "parcelRequire6762")

//# sourceMappingURL=index.bd8c0f79.js.map
